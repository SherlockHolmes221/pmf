...
from utils.logging import log_stats, log_stats0
...
class TrainingStats(object):
    ...
    def UpdateIterStats(self, model_out, inner_iter=None):
        ...
        # Following code is saved for compatibility of train_net.py and iter_size==1
        total_loss = 0
        if cfg.FPN.FPN_ON:
            loss_rpn_cls_data = 0
    ...
    def LogIterStats(self, cur_iter, lr):
        ...
        if (cur_iter % self.LOG_PERIOD == 0 or
            ...
            log_stats0(stats, self.misc_args)
    ...
    def GetStats(self, cur_iter, lr):
        ...
        for k, v in self.smoothed_losses.items():
            ...
            elif len(toks) == 4 and toks[1] == 'hoi':
                hoi_losses.append((k, v.GetMedianValue()))
            elif len(toks) == 5 and toks[1] == 'hoi':
                hoi_losses.append((k, v.GetMedianValue()))
            else:
        ...
        stats['hoi_losses'] = OrderedDict(hoi_losses)
