...
class PMFNet_Baseline(nn.Module):
    ...
    def __init__(self, dim_in, roi_xform_func, spatial_scale):
        ...
        hidden_dim = cfg.HICO.MLP_HEAD_DIM
        print('.......hidden_dim of HICO HOI: ', hidden_dim)
    ...
    def forward(self, x, hoi_blob):
        ...
        # print(x_human.size()) # torch.Size([2, 256])
        # print(x_object.size())  # torch.Size([3, 256])
        ...
        # print(x_union.size()) # torch.Size([6, 256]
        ...
        # print(x_pose_line.size())  # torch.Size([6, 256]
        ...
        # print(x_interaction.size())  # torch.Size([6, 256]
        ...
        hoi_blob['interaction_affinity_score'] = torch.zeros((interaction_human_inds.shape[0], 1)).cuda(
            device_id)  ### 2 classisification score
...
class PMFNet_Final(nn.Module):
    ...
    def loss(hoi_blob):
        ...
        interaction_affinity_loss = cfg.HICO.AFFINITY_WEIGHT * F.binary_cross_entropy_with_logits(
            interaction_affinity_score, interaction_affinity_label, size_average=True)
        interaction_affinity_preds = (interaction_affinity_score.sigmoid() > cfg.HICO.ACTION_THRESH).type_as(
