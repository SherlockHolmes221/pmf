...
def add_rpn_blobs(blobs, im_scales, roidb):
    ...
    valid_keys = [
        'id', 'flipped', 'has_visible_keypoints', 'boxes', 'segms', 'seg_areas', 'gt_classes',
        'gt_overlaps', 'is_crowd', 'box_to_gt_ind_map', 'gt_keypoints',
        'gt_actions', 'gt_role_id', 'precomp_boxes', 'precomp_keypoints', 'precomp_score',
    ]
...
def add_rpn_blobs_hico(blobs, im_scales, roidb):
    """Add blobs needed training RPN-only and end-to-end Faster R-CNN models."""
    if cfg.FPN.FPN_ON and cfg.FPN.MULTILEVEL_RPN:
        # RPN applied to many feature levels, as in the FPN paper
        k_max = cfg.FPN.RPN_MAX_LEVEL
    ...
    valid_keys = [
        'image_id', 'flipped',
        'precomp_boxes', 'precomp_keypoints', 'precomp_score', "precomp_cate",
        "precomp_prob_mask","precomp_prob_cluster_mask",
        'gt_human_boxes', 'gt_object_boxes', 'gt_verb_vec', 'gt_verb_index',
        'gt_hoi_ids', 'has_visible_keypoints', 'gt_hoi_vec', 'gt_obj_cat',"gt_cluster_index",
        'gt_human_mask'
    ]
